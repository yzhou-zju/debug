...
class PolyTraj {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('constraint_aware')) {
        this.constraint_aware = initObj.constraint_aware
      }
      else {
        this.constraint_aware = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [constraint_aware]
    bufferOffset = _serializer.float32(obj.constraint_aware, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [constraint_aware]
    data.constraint_aware = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'cc2c85cff0edc31ab77c1c4679133adb';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.constraint_aware !== undefined) {
      resolved.constraint_aware = msg.constraint_aware;
    }
    else {
      resolved.constraint_aware = 0.0
    }
