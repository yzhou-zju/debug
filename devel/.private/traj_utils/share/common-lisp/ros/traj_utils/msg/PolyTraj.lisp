...
(cl:defclass <PolyTraj> (roslisp-msg-protocol:ros-message)
  ((drone_id
   ...
   :initform (cl:make-array 0 :element-type 'cl:float :initial-element 0.0))
   (constraint_aware
    :reader constraint_aware
    :initarg :constraint_aware
    :type cl:float
    :initform 0.0))
)
...
(cl:ensure-generic-function 'constraint_aware-val :lambda-list '(m))
(cl:defmethod constraint_aware-val ((m <PolyTraj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-msg:constraint_aware-val is deprecated.  Use traj_utils-msg:constraint_aware instead.")
  (constraint_aware m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PolyTraj>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'constraint_aware))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PolyTraj>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'duration)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'constraint_aware) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PolyTraj>)))
  ...
  "cc2c85cff0edc31ab77c1c4679133adb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PolyTraj)))
  "Returns md5sum for a message object of type 'PolyTraj"
  "cc2c85cff0edc31ab77c1c4679133adb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PolyTraj>)))
  ...
  (cl:format cl:nil "int16 drone_id #来源于哪个飞机~%int32 traj_id   ~%time start_time~%~%uint8 order #多项式阶次~%float32[] coef_x       #x方向系数~%float32[] coef_y~%float32[] coef_z~%float32[] duration~%float32   constraint_aware~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PolyTraj)))
  "Returns full string definition for message of type 'PolyTraj"
  (cl:format cl:nil "int16 drone_id #来源于哪个飞机~%int32 traj_id   ~%time start_time~%~%uint8 order #多项式阶次~%float32[] coef_x       #x方向系数~%float32[] coef_y~%float32[] coef_z~%float32[] duration~%float32   constraint_aware~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PolyTraj>))
  ...
  (cl:list 'PolyTraj
    ...
    (cl:cons ':constraint_aware (constraint_aware msg))
))
