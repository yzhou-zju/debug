...
(cl:defmethod cl:initialize-instance :after ((m <GlbObsRcv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlbObsRcv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<GlbObsRcv-request> is deprecated: use traj_utils-srv:GlbObsRcv-request instead.")))

(cl:ensure-generic-function 'req-val :lambda-list '(m))
(cl:defmethod req-val ((m <GlbObsRcv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:req-val is deprecated.  Use traj_utils-srv:req instead.")
  (req m))
...
(cl:defmethod cl:initialize-instance :after ((m <GlbObsRcv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlbObsRcv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<GlbObsRcv-response> is deprecated: use traj_utils-srv:GlbObsRcv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <GlbObsRcv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:result-val is deprecated.  Use traj_utils-srv:result instead.")
  (result m))
