...
struct SwarmGlobalPathList_
{
  ...
  SwarmGlobalPathList_(const ContainerAllocator& _alloc)
    ...
    , swarm_global_path_scale(_alloc)  {
  (void)_alloc;
    }
  ...
  _path_num_type path_num;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _swarm_global_path_x_type;
  _swarm_global_path_x_type swarm_global_path_x;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _swarm_global_path_y_type;
  _swarm_global_path_y_type swarm_global_path_y;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _swarm_global_path_z_type;
  _swarm_global_path_z_type swarm_global_path_z;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _swarm_global_path_scale_type;
  _swarm_global_path_scale_type swarm_global_path_scale;
...
bool operator==(const ::traj_utils::SwarmGlobalPathList_<ContainerAllocator1> & lhs, const ::traj_utils::SwarmGlobalPathList_<ContainerAllocator2> & rhs)
{
  return lhs.guard_drone_id == rhs.guard_drone_id &&
    ...
    lhs.swarm_global_path_scale == rhs.swarm_global_path_scale;
}
...
struct MD5Sum< ::traj_utils::SwarmGlobalPathList_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x015139dac170a0f9ULL;
  static const uint64_t static_value2 = 0x242e5a66432e43eeULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::traj_utils::SwarmGlobalPathList_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.swarm_global_path_scale);
    }
...
struct Printer< ::traj_utils::SwarmGlobalPathList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::traj_utils::SwarmGlobalPathList_<ContainerAllocator>& v)
  {
    ...
    s << indent << "swarm_global_path_scale[]" << std::endl;
    for (size_t i = 0; i < v.swarm_global_path_scale.size(); ++i)
    {
      s << indent << "  swarm_global_path_scale[" << i << "]: ";
      Printer<float>::stream(s, indent + "  ", v.swarm_global_path_scale[i]);
    }
  }
};
